...
public class StepCalculatorService extends Service implements SensorEventListener {
    private SensorManager mSensorManager;
    private int currentValue=0;
    private static final String LOG_TAG = "MyHeart";
    private IBinder binder = new StepCalculatorServiceBinder();
    ...
    /**
     */
    public class StepCalculatorServiceBinder extends Binder {
    ...
    public void onCreate() {
        ...
        Sensor mHeartRateSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_STEP_COUNTER);
