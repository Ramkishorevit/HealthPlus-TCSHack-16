...
public class RunAPI {
    ...
    public void getRestaraunt(Context context,String lat,String lng) {
        ...
        if (mServerAuthenticateListener != null) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, run_suggestion_url+"lat="+lat+"&lng="+lng, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    Type fooType = new TypeToken<ArrayList<Run>>() {
                    }.getType();
                    List<Run> posts = gson.fromJson(response, fooType);
    ...
    public interface ServerAuthenticateListeners {
        ...
        void onRequestCompleted(int code, List<Run> data);
